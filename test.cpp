...
CxxTest::StaticSuiteDescription suiteDescription_LogTS( "./xplat/test/XLogTS.h", 8, "LogTS", suite_LogTS, Tests_LogTS );

static class TestDescription_suite_LogTS_testLog : public CxxTest::RealTestDescription {
public:
 TestDescription_suite_LogTS_testLog() : CxxTest::RealTestDescription( Tests_LogTS, suiteDescription_LogTS, 35, "testLog" ) {}
...
public:
 TestDescription_suite_XSocketUdpTS_testBindLocal2() : CxxTest::RealTestDescription( Tests_XSocketUdpTS, suiteDescription_XSocketUdpTS, 33, "testBindLocal2" ) {}
...
public:
 TestDescription_suite_XSocketUdpTS_testLoopback4() : CxxTest::RealTestDescription( Tests_XSocketUdpTS, suiteDescription_XSocketUdpTS, 38, "testLoopback4" ) {}
...
public:
 TestDescription_suite_XSocketUdpTS_testLoopback6() : CxxTest::RealTestDescription( Tests_XSocketUdpTS, suiteDescription_XSocketUdpTS, 56, "testLoopback6" ) {}
...
public:
 TestDescription_suite_XSockAddrTS_testBadAddrString() : CxxTest::RealTestDescription( Tests_XSockAddrTS, suiteDescription_XSockAddrTS, 41, "testBadAddrString" ) {}
...
public:
 TestDescription_suite_XSockAddrTS_testAltAddrString() : CxxTest::RealTestDescription( Tests_XSockAddrTS, suiteDescription_XSockAddrTS, 60, "testAltAddrString" ) {}
...
public:
 TestDescription_suite_XSockAddrTS_testLookup() : CxxTest::RealTestDescription( Tests_XSockAddrTS, suiteDescription_XSockAddrTS, 84, "testLookup" ) {}
...
public:
 TestDescription_suite_XSockAddrTS_testLocal() : CxxTest::RealTestDescription( Tests_XSockAddrTS, suiteDescription_XSockAddrTS, 111, "testLocal" ) {}
...
public:
 TestDescription_suite_ListTS_testFirstAndLast() : CxxTest::RealTestDescription( Tests_ListTS, suiteDescription_ListTS, 7, "testFirstAndLast" ) {}
...
public:
 TestDescription_suite_ListTS_testIteratorOffsets() : CxxTest::RealTestDescription( Tests_ListTS, suiteDescription_ListTS, 24, "testIteratorOffsets" ) {}
...
public:
 TestDescription_suite_ListTS_testIteratorOutOfBounts() : CxxTest::RealTestDescription( Tests_ListTS, suiteDescription_ListTS, 41, "testIteratorOutOfBounts" ) {}
...
public:
 TestDescription_suite_ListTS_testAppendPrepend() : CxxTest::RealTestDescription( Tests_ListTS, suiteDescription_ListTS, 60, "testAppendPrepend" ) {}
...
public:
 TestDescription_suite_ListTS_testInsertBeforeAfter() : CxxTest::RealTestDescription( Tests_ListTS, suiteDescription_ListTS, 77, "testInsertBeforeAfter" ) {}
...
public:
 TestDescription_suite_ListTS_testRemoveInCycle() : CxxTest::RealTestDescription( Tests_ListTS, suiteDescription_ListTS, 95, "testRemoveInCycle" ) {}
...
public:
 TestDescription_suite_ListTS_testReplaceInCycle() : CxxTest::RealTestDescription( Tests_ListTS, suiteDescription_ListTS, 119, "testReplaceInCycle" ) {}
...
public:
 TestDescription_suite_ListTS_testFindFirstLast() : CxxTest::RealTestDescription( Tests_ListTS, suiteDescription_ListTS, 161, "testFindFirstLast" ) {}
...
public:
 TestDescription_suite_ListTS_testReverse() : CxxTest::RealTestDescription( Tests_ListTS, suiteDescription_ListTS, 184, "testReverse" ) {}
...
public:
 TestDescription_suite_ListTS_testSwapLinks() : CxxTest::RealTestDescription( Tests_ListTS, suiteDescription_ListTS, 219, "testSwapLinks" ) {}
...
public:
 TestDescription_suite_ListTS_testCRTP() : CxxTest::RealTestDescription( Tests_ListTS, suiteDescription_ListTS, 257, "testCRTP" ) {}
...
public:
 TestDescription_suite_ThreadTS_testThread() : CxxTest::RealTestDescription( Tests_ThreadTS, suiteDescription_ThreadTS, 31, "testThread" ) {}
...
public:
 TestDescription_suite_TimingTS_testTimerCancel() : CxxTest::RealTestDescription( Tests_TimingTS, suiteDescription_TimingTS, 85, "testTimerCancel" ) {}
...
public:
 TestDescription_suite_TimingTS_testTimerCancel2() : CxxTest::RealTestDescription( Tests_TimingTS, suiteDescription_TimingTS, 102, "testTimerCancel2" ) {}
...
public:
 TestDescription_suite_TimingTS_testTimerCancelInHandler() : CxxTest::RealTestDescription( Tests_TimingTS, suiteDescription_TimingTS, 118, "testTimerCancelInHandler" ) {}
...
public:
 TestDescription_suite_TimingTS_testTimerMultiple() : CxxTest::RealTestDescription( Tests_TimingTS, suiteDescription_TimingTS, 127, "testTimerMultiple" ) {}
...
public:
 TestDescription_suite_TimingTS_testTimerRepeats() : CxxTest::RealTestDescription( Tests_TimingTS, suiteDescription_TimingTS, 153, "testTimerRepeats" ) {}
...
public:
 TestDescription_suite_TimingTS_testTimerDrift() : CxxTest::RealTestDescription( Tests_TimingTS, suiteDescription_TimingTS, 189, "testTimerDrift" ) {}
...
public:
 TestDescription_suite_KadNodeIdTS_testOperations() : CxxTest::RealTestDescription( Tests_KadNodeIdTS, suiteDescription_KadNodeIdTS, 7, "testOperations" ) {}
...
#include "./src/test/KadTransactionMgrTS.h"

static KadTransactionMgrTS suite_KadTransactionMgrTS;

static CxxTest::List Tests_KadTransactionMgrTS = { 0, 0 };
CxxTest::StaticSuiteDescription suiteDescription_KadTransactionMgrTS( "./src/test/KadTransactionMgrTS.h", 4, "KadTransactionMgrTS", suite_KadTransactionMgrTS, Tests_KadTransactionMgrTS );

static class TestDescription_suite_KadTransactionMgrTS_testPing : public CxxTest::RealTestDescription {
public:
 TestDescription_suite_KadTransactionMgrTS_testPing() : CxxTest::RealTestDescription( Tests_KadTransactionMgrTS, suiteDescription_KadTransactionMgrTS, 7, "testPing" ) {}
 void runTest() { suite_KadTransactionMgrTS.testPing(); }
} testDescription_suite_KadTransactionMgrTS_testPing;
